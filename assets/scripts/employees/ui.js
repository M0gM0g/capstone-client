...
const showUserEmployees = require('../templates/helpers/userEmployee.handlebars')

const createEmployeeSuccess = function (createEmployeeResponse) {
  $('#create-employee-form')[0].reset()
  $('#create-employee-error').hide()
  $('#successModal').modal('show')
  $('#success-message').text('You successfully created an employee!')
}
...
const updateEmployeeSuccess = function (updateEmployeeResponse) {
  $('#successModal').modal('show')
