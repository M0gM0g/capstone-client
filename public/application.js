...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://stormy-mesa-16781.herokuapp.com',
...
var employeeEvents = __webpack_require__(14);
...
$(function () {
  ...
  $('.your-employees').hover(function () {
    $(this).css({ 'background-color': '#6d6d6d' });
  }, function () {
    $(this).css({ 'background-color': '#bbbbbb' });
  });
  $('.all-employees').hover(function () {
...
var onRegister = function onRegister(event) {
  ...
  authApi.register(data).then(authUi.registerSuccess).catch(authUi.registerError);
};

var onLogIn = function onLogIn(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  authApi.logIn(data).then(authUi.logInSuccess).catch(authUi.logInError);
};

var onLogInFormLink = function onLogInFormLink(event) {
  $('#register-error').hide();
...
var onRegisterFormLink = function onRegisterFormLink(event) {
  $('#login-error').hide();
  $('#login-form')[0].reset();
...
module.exports = {
  ...
  onLogIn: onLogIn,
  onLogInFormLink: onLogInFormLink,
  onRegisterFormLink: onRegisterFormLink,
...
var registerSuccess = function registerSuccess(registerResponse) {
  store.user = registerResponse.user;
  $('#register-error').hide();
  $('#register-form')[0].reset();
  $('#register-success').show();
  $('#register-success').html('Welcome ' + store.user.email + ', Please Log In');
...
var registerError = function registerError(_registerError) {
...
var logInError = function logInError(_logInError) {
...
var signOutError = function signOutError(_signOutError) {};
...
var getFormFields = __webpack_require__(4);
var employeesApi = __webpack_require__(15);
var employeesUi = __webpack_require__(16);

var onDashNav = function onDashNav(event) {
  event.preventDefault();
  $('#create-employee').delay(100).fadeOut(100);
  $('#dash-nav').delay(100).fadeOut(100);
  $('#dashboard').delay(200).fadeIn(100);
...
var onCreateEmployeeTab = function onCreateEmployeeTab(event) {
  event.preventDefault();
  $('#dashboard').delay(100).fadeOut(100);
...
var onCreateEmployee = function onCreateEmployee(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  employeesApi.createEmployee(data).then(employeesUi.createEmployeeSuccess).catch(employeesUi.createEmployeeError);
};

var onGetEmployees = function onGetEmployees(event) {
  event.preventDefault();
  // const data = getFormFields(event.target)
  employeesApi.getEmployees().then(employeesUi.getEmployeesSuccess).catch(employeesUi.getEmployeesError);
};

var onRemoveEmployee = function onRemoveEmployee(event) {
  event.preventDefault();
  var employeeId = $(event.target).attr('data-id');

  employeesApi.removeEmployee(employeeId).then(refreshEmployeesOnDelete).catch(employeesUi.removeEmployeeError);
};
...
var onUpdateEmployee = function onUpdateEmployee(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  var employeeId = $(event.target).attr('data-id');

  employeesApi.updateEmployee(data, employeeId).then(employeesUi.updateEmployeeSuccess).catch(employeesUi.updateEmployeeError).then(refreshEmployees);
};

var refreshEmployees = function refreshEmployees(event) {
  $('.show-content').html('');
  employeesApi.getEmployees().then(employeesUi.getEmployeesSuccess).catch();
};

var onGetUserEmployees = function onGetUserEmployees(event) {
  event.preventDefault();
  employeesApi.getEmployees().then(employeesUi.getUserEmployeesSuccess).catch(employeesUi.getUserEmployeesError);
};

var refreshEmployeesOnDelete = function refreshEmployeesOnDelete(event) {
  $('.show-content').html('');
  employeesApi.getEmployees().then(employeesUi.removeEmployeeSuccess).catch();
};
module.exports = {
  ...
  onCreateEmployeeTab: onCreateEmployeeTab,
  onDashNav: onDashNav,
  onGetUserEmployees: onGetUserEmployees
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var getEmployees = function getEmployees(data) {
  return $.ajax({
    method: 'GET',
    url: config.apiUrl + '/employees',
    headers: {
...
var updateEmployee = function updateEmployee(data, employeeId) {
  return $.ajax({
    method: 'PATCH',
    url: config.apiUrl + '/employees/' + employeeId,
    data: data,
...
var store = __webpack_require__(3);
var showAllEmployees = __webpack_require__(17);
// const showEmployeesEdit = require('../templates/helpers/showEmployeeEdit.handlebars')

var createEmployeeSuccess = function createEmployeeSuccess(createEmployeeResponse) {
...
var createEmployeeError = function createEmployeeError(_createEmployeeError) {
  $('#create-employee-form')[0].reset();
  $('#create-employee-error').delay(100).fadeIn(100);
};

var getEmployeesSuccess = function getEmployeesSuccess(data) {
  store.employees = data.employees;
  if (data.employees.length > 0) {
    var showEmployeesHtml = showAllEmployees({
...
var getEmployeesError = function getEmployeesError(data) {};
...
var getUserEmployeesError = function getUserEmployeesError(data) {};
...
var updateEmployeeSuccess = function updateEmployeeSuccess(updateSurveyResponse) {
  $('#successModal').modal('show');
  $('#success-message').html('Your employee has been updated!');
};

var updateEmployeeError = function updateEmployeeError(_updateEmployeeError) {};

var removeEmployeeSuccess = function removeEmployeeSuccess(data) {
  store.employees = data.employees;
  var userEmployees = [];
  for (var i = 0; data.employees.length > i; i++) {
    if (data.employees[i].owner === store.user._id) {
      userEmployees.push(data.employees[i]);
    }
  }
  ...
  if (userEmployees.length > 0) {
    var showUserEmployeesHtml = showAllEmployees({
      employees: userEmployees
    });
    $('#create-employee').delay(100).fadeOut(100);
    $('#dashboard').delay(100).fadeOut(100);
...
var removeEmployeeError = function removeEmployeeError(_removeEmployeeError) {};

module.exports = {
  createEmployeeSuccess: createEmployeeSuccess,
  createEmployeeError: createEmployeeError,
  getEmployeesSuccess: getEmployeesSuccess,
  getEmployeesError: getEmployeesError,
  removeEmployeeSuccess: removeEmployeeSuccess,
  removeEmployeeError: removeEmployeeError,
  updateEmployeeSuccess: updateEmployeeSuccess,
  updateEmployeeError: updateEmployeeError,
  getUserEmployeesError: getUserEmployeesError
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n  <div class=\"handlebars\" id=\"employee-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n    <div class=\"card-body col-sm-2 col-med-2\" style=\"background-color: #d4d4d4; width: 90%; min-height: 300px; padding-top: 20px;\">\n      <h3 data-id="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "><strong>"
    ...
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "><small>$"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.salary : stack1), depth0))
    + "</small></h4>\n      <h4>Goals</h4>\n      <h4 data-id="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "><small>"
    ...
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "><small>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.reviews : stack1), depth0))
    + "</small></h4>\n      <h4>Hire Date</h4>\n      <h4 data-id="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "><small>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.date : stack1), depth0))
    + "</small></h4>\n<h2><small>Update Employee Salary Below</small></h2>\n      <form class='update-employee' data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n              <!-- <input type=\"text\" name=\"survey[question]\" tabindex=\"4\" class=\"form-control\" placeholder=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
    + "\" required> -->\n              <input type=\"intiger\" name=\"employee[salary]\" tabindex=\"4\" class=\"form-control\" placeholder=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.salary : stack1), depth0))
    + "\" required>\n              <!-- <input type=\"text\" name=\"survey[question]\" tabindex=\"4\" class=\"form-control\" placeholder=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.goals : stack1), depth0))
    + "\" required>\n              <input type=\"text\" name=\"survey[question]\" tabindex=\"4\" class=\"form-control\" placeholder=\""
    ...
    + "\" required>\n              <input type=\"text\" name=\"survey[question]\" tabindex=\"4\" class=\"form-control\" placeholder=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.date : stack1), depth0))
    + "\" required> -->\n\n\n\n        <button style=\"margin: 15px 5px;\" class=\"btn btn-style update-employee\" data-id='"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "'>UPDATE EMPLOYEE</button>\n        <button style=\"margin: 15px 5px;\" class=\"btn btn-danger btn-style delete-employee\" data-id='"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "'>DELETE EMPLOYEE</button>\n      </form>\n    </div>\n  </div>\n\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.employees : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
